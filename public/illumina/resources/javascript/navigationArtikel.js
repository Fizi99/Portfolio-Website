...
let btn = document.getElementById("kaufButton");

//abspeichern der Produktdetail in lokale Storage
btn.addEventListener("click", function() {
    localStorage.setItem("preis", document.getElementById("Preis").innerHTML );
    localStorage.setItem("gegenstand", document.getElementById("gegenstand").innerText );
